...
def generate_test_description():
    ...
    global sm_count_per_trunk
    sm_count_per_trunk = gpu_partition.get_sm_count_per_trunk()
    print(f'SM count per trunk: {sm_count_per_trunk}')
...
class TestStartServer(unittest.TestCase):
    ...
    def test_gpu_partition_info_callback(self):
        ...
        global sm_count_per_trunk
        self.assertLess(
            received_sm_count, sm_count + sm_count_per_trunk,
            'sm_count reported by GpuPartitionTestNode ({received_sm_count}) != '
            'sm_count per trunk ({sm_count_per_trunk})'
        )
