...
def generate_test_description():
    ...
    camera_drop_node = ComposableNode(
        ...
        namespace=CameraDropNodeMode0Test.generate_namespace(),
        parameters=[{
                    'X': DROP_COUNT,
                    'Y': TOTAL_COUNT,
                    'mode': 'mono'
    ...
    return CameraDropNodeMode0Test.generate_test_description([container])


class CameraDropNodeMode0Test(IsaacROSBaseTest):
    """Test CameraDropNode in Mode = mono."""
    ...
    def test_drop_node(self) -> None:
        ...
        try:
            ...
            output_topics = ['image_1_drop', 'camera_info_1_drop']
