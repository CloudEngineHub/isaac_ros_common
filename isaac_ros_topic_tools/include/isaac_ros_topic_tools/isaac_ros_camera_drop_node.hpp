...
#ifndef ISAAC_ROS_TOPIC_TOOLS__ISAAC_ROS_CAMERA_DROP_NODE_HPP_
#define ISAAC_ROS_TOPIC_TOOLS__ISAAC_ROS_CAMERA_DROP_NODE_HPP_
...
{
/**
 * @brief CameraDropNode class implements a node that
 ...
 *        dropped or not.
 */
class CameraDropNode : public rclcpp::Node
{
public:
  /**
   * @brief Constructor for CameraDropNode class.
   * @param options The node options.
   */
  explicit CameraDropNode(const rclcpp::NodeOptions & options);
...
#endif  // ISAAC_ROS_TOPIC_TOOLS__ISAAC_ROS_CAMERA_DROP_NODE_HPP_
